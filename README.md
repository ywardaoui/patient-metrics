...
```bash
git clone https://github.com/your-github-username/patient-metrics.git
cd patient-metrics/
# start working...
```
...
* Retrieve all patients and show the min, max, average, and median heart rate.
* Retrieve all patients and view in a table
* Create a patient and assign it to a doctor
* Update a patient 
* Delete a patient
* BONUS: show the patient with highest heart rate for each doctor
